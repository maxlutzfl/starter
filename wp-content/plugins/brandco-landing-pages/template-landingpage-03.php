...
<body class="<?php if (BrandcoLandingPages_Image($parentid)) { echo 'has-post-thumbnail'; }; ?>" itemscope itemtype="http://schema.org/WebPage">
	...
	<style>
		...
		body:before {
			...
			background-size: cover;
			background-position: 50%;			
			background-image: url('<?php echo BrandcoLandingPages_Image($parentid); ?>');			
		}

		#bco-landing-pages--wrapper-3 {
			text-align: center;
			position: relative;
			z-index: 20;
		}

		#bco-landing-pages--wrapper-3 h1 {
			color: #fff;
			margin-bottom: 30px;
		}

		#bco-landing-pages--wrapper-3 a {
			color: #fff;
