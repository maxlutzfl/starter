...
b.image.src=d.data.original[0],a(b.image).appendTo(".face-detection-image").on("load",function(){
...
console.log("error",d,a),b.update_status("Error ("+c+"): "+d)}})},show_existing:function(c,d){d=d||"normal";var e=a(b.image).width(),f=b.images.original[1]/e;"undefined"!=typeof c&&c.length&&a.each(c,function(a,c){b.add_hotspot({x:c.x/f,y:c.y/f,width:c.width/f,type:d})})},add_hotspots:function(){var c=a(b.image).width(),d=b.images.original[1]/c;
// activate hotspots
