...
class bco_theme_setup {
	...
	public function __construct() {
		...
		add_action('wp_head', array($this, 'og_website_screenshot_image'));
	...
	public function og_website_screenshot_image() {
		?>
		...
		?>
			<style type="text/css">
				...
				#login h1 a, .login h1 a {
					background-image: url(<?php echo get_template_directory_uri(); ?>/theme-icon.png);
...
/**
 * Initiate the bco_theme_setup class
 */
