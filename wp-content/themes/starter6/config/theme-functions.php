...
function button_shortcode($attributes) {
	return '<p><a href="' . $attributes['link'] . '" class="button-style"><span>' . $attributes['title'] . '</span></a></p>';
}

add_shortcode('make_button', 'button_shortcode');